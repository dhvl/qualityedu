...
export default function CoursePage() {
  const modules = [
  {
    "title": "Resume & Profile Transformation",
    "desc": "ATS optimization, quantifiable metric-driven accomplishment bullet points, LinkedIn headline and summary revamp."
  },
  {
    "title": "STAR Technique & Behavioral Mastery",
    "desc": "Structuring compelling answers for competency-based questions, handling conflict/failure scenarios."
  },
  {
    "title": "Technical & Functional QA Drills",
    "desc": "Live simulated technical rounds for Quality Analysts, Team Leaders, and Process Excellence roles."
  },
  {
    "title": "Offer Negotiation & Final Round Strategy",
    "desc": "Counter-offers, salary negotiation scripts, evaluating equity and benefits packages."
  }
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-8 space-y-6">
              ...
              <p className="text-slate-300 text-base sm:text-lg max-w-2xl leading-relaxed">
                Targeted 1-on-1 coaching, ATS-proof resume rebuilding, mock behavioral drills, and salary negotiation mastery.
              </p>
              <div className="flex flex-wrap items-center gap-6 text-xs text-slate-300 pt-2">
                <div className="flex items-center gap-2">
                  <Clock className="w-4 h-4 text-blue-400" />
                  <span>Duration: 6 Live Classes</span>
                </div>
                <div className="flex items-center gap-2">
                  <Users className="w-4 h-4 text-blue-400" />
                  <span>Level: Job Seekers & Switchers</span>
                </div>
                <div className="flex items-center gap-2">
