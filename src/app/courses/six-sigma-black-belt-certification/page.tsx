...
export default function CoursePage() {
  const modules = [
  {
    "title": "Enterprise Leadership & Deployment",
    "desc": "Aligning Six Sigma projects with organizational business metrics, project portfolio selection, change management."
  },
  {
    "title": "Advanced Measurement & Analytics",
    "desc": "Continuous & attribute Gage R&R, non-normal distribution data analysis, advanced capability metrics."
  },
  {
    "title": "Advanced Hypothesis Testing & ANOVA",
    "desc": "Multi-factor ANOVA, MANOVA, Non-parametric tests (Mann-Whitney, Kruskal-Wallis, Moods Median)."
  },
  {
    "title": "Design of Experiments (DOE)",
    "desc": "Full factorial designs, Fractional factorial designs, Response Surface Methodology (RSM), Taguchi methods."
  },
  {
    "title": "Design for Six Sigma (DFSS) & Robustness",
    "desc": "DMADV (Define, Measure, Analyze, Design, Verify), QFD (House of Quality), Poka-Yoke & Mistake proofing."
  }
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-8 space-y-6">
              ...
              <p className="text-slate-300 text-base sm:text-lg max-w-2xl leading-relaxed">
                Master advanced statistical modeling, Design of Experiments (DOE), enterprise quality leadership, and strategic deployment.
              </p>
              <div className="flex flex-wrap items-center gap-6 text-xs text-slate-300 pt-2">
                <div className="flex items-center gap-2">
                  <Clock className="w-4 h-4 text-blue-400" />
                  <span>Duration: 20-22 Live Classes</span>
                </div>
                <div className="flex items-center gap-2">
                  <Users className="w-4 h-4 text-blue-400" />
                  <span>Level: Advanced / Leaders</span>
                </div>
                <div className="flex items-center gap-2">
