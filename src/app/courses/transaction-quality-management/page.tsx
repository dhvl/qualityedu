...
export default function CoursePage() {
  const modules = [
  {
    "title": "Module 1: Introduction to Quality & QA Role",
    "desc": "Evolution of Quality, Role of QA in BPO/Operations, Customer experience metrics (CSAT, NPS, FCR, QA Score)."
  },
  {
    "title": "Module 2: Sampling Techniques & Error Categorization",
    "desc": "Random, stratified, and targeted sampling. Critical vs Non-Critical errors, fatal defects and scoring mechanics."
  },
  {
    "title": "Module 3: Quality Monitoring & Forms Design",
    "desc": "Designing effective checksheets, behavioral evaluation parameters, audit hygiene and objectivity."
  },
  {
    "title": "Module 4: Calibration & Variance Reduction",
    "desc": "Conducting calibration sessions, Gauge R&R concepts for transactional data, reducing audit variances."
  },
  {
    "title": "Module 5: Feedback Delivery & Coaching Models",
    "desc": "GROW coaching model, corrective action plans (CAP), root cause analysis for bottom performers."
  },
  {
    "title": "Module 6: Governance, Reporting & Dashboards",
    "desc": "Weekly/Monthly Quality reviews (WBR/MBR), trend analysis, reporting to client leadership."
  }
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-8 space-y-6">
              ...
              <p className="text-slate-300 text-base sm:text-lg max-w-2xl leading-relaxed">
                Master QA frameworks, sampling, calibration, coaching models and quality governance for contact centers and operations.
              </p>
