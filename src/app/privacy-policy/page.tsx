...
export const metadata = {
  title: "Privacy Policy | QE&D",
  description: "Official Privacy Policy for Quality Education & Deployment (QE&D).",
};

export default function LegalPage() {
  const data = (pagesData as Record<string, any>)["privacy-policy"];
  return (
